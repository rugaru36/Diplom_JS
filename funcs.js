...
//   //первая четверть
//   if (angle >= 0 && angle <= 90) {
//     return [Math.sin(degToRad(90 - angle)) * length, Math.sin(degToRad(angle)) * length]
//   } else if (angle > 90 && angle < 180) { //вторая четверть
//     return [Math.sin(degToRad(90 - (180 - angle))) * length * (-1), Math.sin(degToRad((180 - angle))) * length]
//   } else if (angle >= 180 && angle <= 270) { //третья четверть
//     return [Math.sin(degToRad(90 - (angle - 180))) * length * (-1), Math.sin(degToRad((angle - 180))) * length * (-1)]
//   } else if (angle > 270 && angle < 360) { //четвертая четверть
//     return [Math.sin(degToRad(90 - (360 - angle))) * length, Math.sin(degToRad((360 - angle))) * length * (-1)]
//   }
// }
