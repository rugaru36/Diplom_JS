...
function onPlus(idOfElement) {
  ...
  if (idOfElement == "pursuiterRadius" || idOfElement == "escaperRadius") {
    sizeOfStep = 0.5
  } else if (idOfElement == "pursuiterVectorAngle") {
    sizeOfStep = 10
  } else if (idOfElement == "escaperVectorDirection") {
    sizeOfStep = 10
  } else if (idOfElement == "pursuiterVectorDirection") {
    sizeOfStep = 10
  } else if (idOfElement == "h") {
    sizeOfStep = 0.01
  } else if (idOfElement == "accuracy") {
    sizeOfStep = 0.05
  } else if (idOfElement == "speed") {
    sizeOfStep = 0.5
  }
  else sizeOfStep = 1
...
function onMinus(idOfElement) {
  ...
  if (idOfElement == "pursuiterVectorAngle" || idOfElement == "escaperVectorDirection"
    || idOfElement == "pursuiterVectorDirection") {
    sizeOfStep = 10
  }
